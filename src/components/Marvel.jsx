  ...
  return (
    ...
    <div className='grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto'>
       ...
       return (
        ...
        <a 
          href={elem.url} 
          className='mt-4 font-bold  hover:bg-blue-500 text-blue-400 hover:text-white border-blue-400 w-full h-12 border-1 flex justify-center rounded-2xl items-center transition-all duration-300 active:scale-95'
        >
          Watch now
        </a>
